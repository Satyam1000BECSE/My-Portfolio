...
function submitRecommendation() {
    ...
    if (recommendationText !== '') {
        addRecommendation(recommendationText, currentUserId); // Add recommendation to the UI
...
function saveRecommendation(text, userId) {
    ...
    updateIndices(); // Update indices for delete functionality
}
...
function updateIndices() {
    ...
    Array.from(recommendationsList).forEach((item, index) => {
        item.index = index; // Update the index of each recommendation
    });
}
