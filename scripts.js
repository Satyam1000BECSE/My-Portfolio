// Skill data
const skills = [
    { name: "HTML", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg", percentage: 90, description: "Proficient in creating structured and semantic web pages using HTML5.", certificate: "Coursera H97FANX7KULC.pdf" },
    { name: "CSS", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg", percentage: 85, description: "Skilled in designing responsive and visually appealing web pages using CSS3.", certificate: "Coursera H97FANX7KULC.pdf" },
    { name: "JavaScript", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg", percentage: 80, description: "Experienced in writing dynamic and interactive web applications using JavaScript.", certificate: "Coursera H97FANX7KULC.pdf" },
